...
<link rel="stylesheet" href="http://localhost:8888/thibaultrivrain/sc/css/sc-player-standard.css?version=26" type="text/css">
</head>
...
<div id="header">
	...
	<div class="logo">
		...
		<h1 class="blog-name"><a href="<?php bloginfo('url'); ?>"><?php bloginfo('name');?></h1>
		<!-- h2 class="blog-description"><?php bloginfo('description'); ?></h2 -->
		<?php else: ?>
		<span class="blog-name"><a href="<?php bloginfo('url'); ?>"><?php bloginfo('name');?></span>
		<!-- span class="blog-description"><?php bloginfo('description'); ?></span -->
		<?php endif ?>
	</div>

	<div id="social">
<a class="social-logosmall" href="https://soundcloud.com/thibaultrivrain" target="_blank"><img src="/wp-content/uploads/2012/12/soundcloud-white-30.png"></a>
<a class="social-logosmall" href="http://thibaultrivrain.bandcamp.com" target="_blank"><img src="/wp-content/uploads/2012/12/bandcamp-white-25.png"></a>
<a class="social-logo" href="http://www.facebook.com/thibaultrivrain.music" target="_blank"><img src="/wp-content/uploads/2012/12/facebook-white-30.png"></a>
	</div>	
