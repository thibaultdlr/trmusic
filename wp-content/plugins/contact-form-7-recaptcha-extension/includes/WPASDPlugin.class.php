...
if (!class_exists('WPASDPlugin')) {
	...
	static function uninstall_options($options_name) {
        ...
        /**
         * Throwing debugging output into Debug My Plugin (3rd party).
         *
         */
        private static function toDebugBar(
	    $type,
	    $header,
	    $message,
	    $file=null,
        ...
        protected static function debugMessage(
    	    $header,
    	    $message,
    	    $file=null,
    	    $line=null) {
    	    
    	    WPASDPlugin::toDebugBar('message', $header, $message, $file, $line);
        }
        
        protected static function debugValue(
    	    $header,
    	    $value,
    	    $file=null,
    	    $line=null) {
