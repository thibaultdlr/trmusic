...
This plugin provides the *reCAPTCHA* tag for the Contact Form 7 Plugin. It allows the usage of a reCAPTCHA field provided by a 3rd party reCAPTCHA Plugin.
...
[Better WordPress reCAPTCHA](http://wordpress.org/extend/plugins/bwp-recaptcha/ "Better WordPress reCAPTCHA Plugin") now offers an own tag for Contact Form 7.
...
= 0.1.1 = 
We heard the questions for the need of an update because it was broken. It should be fixed now. Please report if things still won't work for you. We try to fix it as soon as possible.
